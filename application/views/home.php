                ...
                <div class="slide1">
                    <div class="container">
                        <div class="content animated fadeInRight">
                            <div class="fl-right">
                            <h1 class="animated fadeInUp">IRFAN AZIZ KHAN</h1>
                            <p class="animated fadeInUp"><b>SABIR ALI GIRLS DEGREE COLLEGE(GAURA-KHAS)KAHANIA GHAZIPUR.</b></p>
                                </div>
                        </div>
                    </div>
                </div>
                ...
                <ul class="row our-links">
                    <li class="col-sm-4 apply-online clearfix equal-hight">
                        ...
                        <div class="detail">
                            ...
                            <a href="<?php echo base_url()?>index.php/welcome/applyonline" class="more"><i class="fa fa-angle-right" aria-hidden="true"></i></a> </div>
                    </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-7 col-sm-push-5 left-block"> <span class="sm-head">the Online Education portal</span>
                        <h2>SABIR ALI GIRLS DEGREE COLLEGE </h2>
                        <p>Building Our College's rich experience with online Education at SABIR ALI GIRLS DEGREE COLLEGE! Designing and delivering both graduate and post-graduate programs across a variety of disciplines, SABIR ALI GIRLS DEGREE COLLEGE Online, offering online MBA has worked upon the knowledge-base created by our highly qualified faculties, our research, publishing and training experience, to create online MBA programs that offer a rich learning experience.</p>
                    ...
                    <div class="col-sm-5 col-sm-pull-7">
                        <div class="video-block">
                            ...
                            <a href="https://www.youtube.com/watch?v=i11RXCJVEnw" class="start-video video"><img src="<?php echo base_url()?>assets/images/play-btn.png" alt=""></a> 
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <ul class="row">
                    <li class="col-sm-4 equal-hight">
                        <div class="inner"> <img src="<?php echo base_url()?>assets/images/study-time-ico.jpg" alt="Malleable Study Time">
                    ...
                    <li class="col-sm-4 equal-hight">
                        <div class="inner"> <img src="<?php echo base_url()?>assets/images/placement-ico.jpg" alt="Placement Assistance">
                            <h3>Placement Assistance</h3>
                            <p>SABIR ALI GIRLS DEGREE COLLEGE has access to all of Edumart Group’s placement resources and alumni network, through which thousands of job opportunities are generated.</p>
                        </div>
                    </li>
                    <li class="col-sm-4 equal-hight">
                        <div class="inner"> <img src="<?php echo base_url()?>assets/images/easy-access-ico.jpg" alt="Easy To Access">
                    ...
                    <li class="col-sm-4 equal-hight">
                        <div class="inner"> <img src="<?php echo base_url()?>assets/images/study-go-ico.jpg" alt="Study on the Go">
                    ...
                    <li class="col-sm-4 equal-hight">
                        <div class="inner"> <img src="<?php echo base_url()?>assets/images/get-innovative-ico.jpg" alt="Get an Innovative, In-depth Transition">
                    ...
                    <li class="col-sm-4 equal-hight">
                        <div class="inner"> <img src="<?php echo base_url()?>assets/images/practical-ico.jpg" alt="Practical & Interactive Participation">
            ...
            <div class="container">
                ...
                <ul class="row">
                    <li class="col-sm-4">
                        ...
                        <figure><img src="<?php echo base_url()?>assets/images/how-study-img1.jpg" class="img-responsive" alt=""></figure>
                    </li>
                    <li class="col-sm-4">
                        <div class="overly">
                            <div class="cnt-block">
                            ...
                            <a href="#" class="more"><i class="fa fa-caret-right" aria-hidden="true"></i></a> </div>
                        <figure><img src="<?php echo base_url()?>assets/images/how-study-img2.jpg" class="img-responsive" alt=""></figure>
                    </li>
                    <li class="col-sm-4">
                        <div class="overly">
                            <div class="cnt-block">
                            ...
                            <a href="#" class="more"><i class="fa fa-caret-right" aria-hidden="true"></i></a> </div>
                        <figure><img src="<?php echo base_url()?>assets/images/how-study-img3.jpg" class="img-responsive" alt=""></figure>
                    </li>
                </ul>
            </div>
        </section>
        ...
        <section class="news-events padding-lg">
            <div class="container">
                ...
                <ul class="row cs-style-3">
                    <li class="col-sm-4">
                        <div class="inner">
                            <figure> <img src="<?php echo base_url()?>assets/images/new-event-img1.jpg" class="img-responsive">
                                <figcaption>
                                    <div class="cnt-block"> <a href="<?php echo base_url()?>index.php/welcome/news" class="plus-icon">+</a>
                    ...
                    <li class="col-sm-4">
                        <div class="inner">
                            <figure> <img src="<?php echo base_url()?>assets/images/new-event-img2.jpg" class="img-responsive">
                                <figcaption>
                                    <div class="cnt-block"> <a href="<?php echo base_url()?>index.php/welcome/news" class="plus-icon">+</a>
                                        <h3>We have added new features to Dream Palace</h3>
                                        <div class="bottom-block clearfix">
                    ...
                    <li class="col-sm-4">
                        <div class="inner">
                            <figure> <img src="<?php echo base_url()?>assets/images/new-event-img3.jpg" class="img-responsive">
                                <figcaption>
                                    <div class="cnt-block"> <a href="<?php echo base_url()?>index.php/welcome/news" class="plus-icon">+</a>
                                        <h3>We have added new features to Dream Palace</h3>
                                        <div class="bottom-block clearfix">
                ...
                <div class="know-more-wrapper"> <a href="<?php echo base_url()?>index.php/welcome/news" class="know-more">More Post <span class="icon-more-icon"></span></a> </div>
            </div>
        </section>
            ...
            <ul class="gallery clearfix">
                <li>
                    <div class="overlay">
                        <h3>Lorem ipsum</h3>
                        <p>Lorem ipsum</p>
                        <a class="galleryItem" href="<?php echo base_url()?>assets/images/pic3.jpeg"><span class="icon-enlarge-icon"></span></a> <a href="<?php echo base_url()?>index.php/welcome/gallery" class="more"><span class="icon-gallery-more-arrow"></span></a> </div>
                    <figure><img src="<?php echo base_url()?>assets/images/pic3.jpeg" class="img-responsive" alt=""></figure>
                </li>
                <li>
                    <div class="overlay">
                        <h3>Lorem ipsum</h3>
                        <p>Lorem ipsum</p>
                        <a class="galleryItem" href="<?php echo base_url()?>assets/images/pic4.jpeg"><span class="icon-enlarge-icon"></span></a> <a href="<?php echo base_url()?>index.php/welcome/gallery" class="more"><span class="icon-gallery-more-arrow"></span></a> </div>
                ...
                <li>
                    <div class="overlay">
                        <h3>Lorem ipsum</h3>
                        <p>Lorem ipsum</p>
                        <a class="galleryItem" href="<?php echo base_url()?>assets/images/pic9.jpeg"><span class="icon-enlarge-icon"></span></a> <a href="<?php echo base_url()?>index.php/welcome/gallery" class="more"><span class="icon-gallery-more-arrow"></span></a> </div>
                    <figure><img src="<?php echo base_url()?>assets/images/pic9.jpeg" class="img-responsive" alt=""></figure>
                </li>
                <li>
                    <div class="overlay">
                        <h3>Lorem ipsum</h3>
                ...
                <!-- <li>
                    <div class="overlay">
                        <h3>Lorem ipsum</h3>
                        <p>Lorem ipsum</p>
                        <a class="galleryItem" href="<?php echo base_url()?>assets/images/pic11.jpeg"><span class="icon-enlarge-icon"></span></a> <a href="<?php echo base_url()?>index.php/welcome/gallery" class="more"><span class="icon-gallery-more-arrow"></span></a> </div>
        ...
        <!-- <section class="logos">
            <div class="container">
                <ul class="owl-carousel clearfix">
                    <li><a href="#"><img src="<?php echo base_url()?>assets/images/logo1.jpg" class="img-responsive" alt=""></a></li>
                    <li><a href="#"><img src="<?php echo base_url()?>assets/images/logo2.jpg" class="img-responsive" alt=""></a></li>
                    <li><a href="#"><img src="<?php echo base_url()?>assets/images/logo3.jpg" class="img-responsive" alt=""></a></li>
                    <li><a href="#"><img src="<?php echo base_url()?>assets/images/logo4.jpg" class="img-responsive" alt=""></a></li>
                    <li><a href="#"><img src="<?php echo base_url()?>assets/images/logo5.jpg" class="img-responsive" alt=""></a></li>
                    <li><a href="#"><img src="<?php echo base_url()?>assets/images/logo6.jpg" class="img-responsive" alt=""></a></li>
                </ul>
            </div>
        </section> -->
        <br>
        ...
        <section class="testimonial padding-lg">
            <div class="container">
                <div class="wrapper">
                    ...
                    <div id="bx-pager"> <a data-slide-index="0" href="#"><img src="<?php echo base_url()?>assets/images/testimonial-thumb1.jpg" class="img-circle" alt=""/></a> <a data-slide-index="1" href="#"><img src="<?php echo base_url()?>assets/images/testimonial-thumb2.jpg" class="img-circle" alt="" /></a> <a data-slide-index="2" href="#"><img src="<?php echo base_url()?>assets/images/testimonial-thumb3.jpg" class="img-circle" alt="" /></a> </div>
                </div>
            </div>
        </section>
