<div class="inner-banner">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-3"> <a href="apply-online.html" class="apply-online clearfix">
                        <div class="left clearfix"> <span class="icon"><img src="<?php echo base_url()?>assets/images/apply-online-sm-ico.png" class="img-responsive" alt=""></span> <span class="txt">Apply Online</span> </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-pull-7">
                        <div class="enquire-wrapper">
                            <figure class="hidden-xs hidden-sm"><img src="<?php echo base_url()?>assets/images/course-img.jpg" class="img-responsive" alt=""></figure>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="course-detail clearfix">
                            ...
                            <a href="apply-online.html" class="btn">apply now <span class="icon-more-icon"></span></a> </div>
                    </div>
                </div>
            </div>
        </section>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><div class="table-col1">
                                                        ...
                                                        Lorem Ipsum is simply dummy </div></td>
                                                    <td><div class="table-col1">
                                                        <div class="lecture-txt">Lecture <span>1.1</span> <a href="#" class="preview">Preview</a> </div>
                                                        Lorem Ipsum is simply dummy </div></td>
                                                    <td><div class="table-col1">
                                        ...
                                        <table class="table course-table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><div class="fee-amt"> $2500</div></td>
                                                </tr>
                                                <tr>
                                                    <td><div class="table-col1"> Short term Installment Plan </div></td>
                                                    <td><div class="fee-amt">$2700</div>
                                ...
                                <div class="tab-pane fade" role="tabpanel" id="teachers" aria-labelledby="teachers-tab">
                                    <ul class="row browse-teachers-list clearfix">
                                        <li class="col-xs-6 col-sm-3">
                                            <figure> <img src="<?php echo base_url()?>assets/images/teacher1.jpg" alt="" width="123" height="124"> </figure>
                                        ...
                                        <li class="col-xs-6 col-sm-3">
                                            <figure> <img src="<?php echo base_url()?>assets/images/teacher2.jpg" alt="" width="123" height="124"> </figure>
                                            <h3>Bruno Acselrad</h3>
                                        ...
                                        <li class="col-xs-6 col-sm-3">
                                            <figure> <img src="<?php echo base_url()?>assets/images/teacher3.jpg" alt="" width="123" height="124"> </figure>
                                            <h3>Bruno Acselrad</h3>
                                        ...
                                        <li class="col-xs-6 col-sm-3">
                                            <figure> <img src="<?php echo base_url()?>assets/images/teacher4.jpg" alt="" width="123" height="124"> </figure>
                                            <h3>Bruno Acselrad</h3>
        ...
        <section class="how-apply padding-lg">
            <div class="container">
                ...
                <ul class="row">
                    <li class="col-sm-4">
                        <div class="icon-block"> <span class="num">1</span> <img src="<?php echo base_url()?>assets/images/registration-ico.png" alt=""></div>
                        <h3>REGISTRATION</h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </li>
                    <li class="col-sm-4">
                        <div class="icon-block"> <span class="num">2</span> <img src="<?php echo base_url()?>assets/images/doc-ico.png" alt=""></div>
                        <h3>DOCUMENTATION</h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                    </li>
                    <li class="col-sm-4 active">
                        <div class="icon-block"> <span class="num">3</span> <img src="<?php echo base_url()?>assets/images/get-start-ico.png" alt=""></div>
