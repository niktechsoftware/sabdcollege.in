                ...
                <div class="row row1">
                    <div class="col-sm-9 clearfix">
                        <div class="foot-nav">
                            <h3>About US</h3>
                            <ul>
                                <li><a href="#">SABIR ALI GIRLS DEGREE COLLEGE</a></li>
                    ...
                    <div class="col-sm-3">
                        <div class="footer-logo hidden-xs"><a href="index-2.html"><img src="<?php echo base_url()?>assets/images/footer-logo.png" class="img-responsive" alt=""></a></div>
                        <p>© 2018 <span>Niktech Sofftware Solution</span>. All rights reserved</p>
