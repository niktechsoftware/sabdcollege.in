        ...
        <section class="google-map">
            ...
            <div class="container">
                <div class="contact-detail">
                    <div class="address">
                        <div class="inner">
                            <h3>SABIR ALI GIRLS DEGREE COLLEGE</h3>
            ...
            <div class="container">
                ...
                <ul class="row">
                    <li class="col-sm-4 equal-hight">
                        <div class="inner"> <img src="<?php echo base_url()?>assets/images/help-center-ico.jpg" alt="Malleable Study Time">
                            <h3>Help Center</h3>
                    ...
                    <li class="col-sm-4 equal-hight">
                        <div class="inner"> <img src="<?php echo base_url()?>assets/images/faq-ico.jpg" alt="Placement Assistance">
                            <h3>Faq’s</h3>
                            <p>SABIR ALI GIRLS DEGREE COLLEGE Online has access to all of Our College's placement resources and alumni network, through which thousands of job opportunities are generated.</p>
                        </div>
                    </li>
                    <li class="col-sm-4 equal-hight">
                        <div class="inner"> <img src="<?php echo base_url()?>assets/images/document-ico.jpg" alt="Easy To Access">
